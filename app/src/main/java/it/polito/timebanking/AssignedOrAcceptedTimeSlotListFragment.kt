...
class AssignedOrAcceptedTimeSlotListFragment: Fragment(R.layout.fragment_assigned_accepted_time_slot_list) {
    private val tabTitle = arrayOf("Assigned", "Accepted")


    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_assigned_accepted_time_slot_list, container, false)
